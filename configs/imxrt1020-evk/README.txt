...
======
  ...
  i.MXRT evaluation kit, MIMXRT1020-EVKB. Some of the features of this
  board include:
    ...
    o Connectivity
      ...
      - Ethernet (10/100T) connector (KSZ8081 PHY)
      - Micro USB Port (USB OTG)
      - CAN Bus (TJA1057GT/3)
      - Arduino® interface

    o Debug

      - CMSIS-DAP (via OpenSDA)
      - LPUART1 Serial Port (via OpenSDA)
      - Firmware Storage (via OpenSDA)
      - SWD Interface (20pin ARM JTAG header)
...
==============
  ...
  Arduino RS-232 Shield:
    ...
    J17 D0 UART_RX/D0  GPIO_AD_B1_09  LPUART2_RX
    J17 D1 UART_TX/D1  GPIO_AD_B1_08  LPUART2_TX
...
================
  ...
  There are four user interface switches on the MIMXRT1020 EVK Board:

    - SW1: Power Switch (slide switch)
    - SW2: ON/OFF Button (Generates the Power OFF interrupt to the CPU)
    - SW3: PoR button (Turn off the power to the CPU)
    - SW4: User button (Wakeup line to the CPU)
